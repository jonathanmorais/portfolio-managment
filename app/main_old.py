...
if __name__ == "__main__":
    ...
    stock_analyzer      = StockMetricsCalculate(weights, stock_return.calculate_portfolio_returns(), stock_return_index.calculate_index_return())

   # portfolio_returns = stock_analyzer.calculate_portfolio_optimization(stock_data_provider)

    print(stock_analyzer.calculate_kurtosis())
